...
mod tests {
    ...
    fn test_is_equal_multiplication() {
        ...
        let expr8 = Expression::multiplication(vec![
...
mod tests_contains {
    ...
    fn test_contains_number() {
        let expr1 = Expression::integer(5);
        let expr2 = Expression::integer(5);
        assert!(expr1.contains(&expr2));

        let expr3 = Expression::integer(3);
        assert!(!expr1.contains(&expr3));

        let expr4 = Expression::rational(1, 2);
        let expr5 = Expression::integer(2);
        assert!(expr4.contains(&expr5));

        let expr6 = Expression::integer(3);
        assert!(!expr4.contains(&expr6));
    }
    ...
    #[test]
    fn test_is_equal_constants() {
        let expr1 = Expression::pi();
        let expr2 = Expression::pi();
        assert!(expr1.contains(&expr2));

        let expr3 = Expression::e();
        assert!(!expr1.contains(&expr3));
    }

    #[test]
    fn test_contains_addition() {
        let expr1 = Expression::addition(vec![Expression::integer(2), Expression::integer(3)]);
        let expr2 = Expression::addition(vec![Expression::integer(2), Expression::integer(3)]);
        assert!(expr1.contains(&expr2));
        ...
        let expr6 = Expression::addition(vec![Expression::integer(3), Expression::integer(2)]);
        assert!(expr5.contains(&expr6));

        let expr7 = Expression::addition(vec![Expression::integer(4), Expression::integer(3)]);
        assert!(expr5.contains(&expr7));

        let expr8 = Expression::addition(vec![Expression::integer(4), Expression::integer(2)]);
        assert!(expr5.contains(&expr8));
    }

    #[test]
    fn test_contains_multiplication() {
        let expr1 =
            Expression::multiplication(vec![Expression::integer(2), Expression::integer(3)]);
        let expr2 =
            Expression::multiplication(vec![Expression::integer(2), Expression::integer(3)]);
    ...
    fn test_contains_division() {
        ...
        let expr3 = Expression::integer(2);
        assert!(expr1.contains(&expr3));

        let expr4 = Expression::division(
            Expression::addition(vec![Expression::integer(2), Expression::integer(3)]),
            Expression::integer(3),
        );
        let expr5 = Expression::addition(vec![Expression::integer(2), Expression::integer(3)]);
        assert!(expr4.contains(&expr5));
    }

    #[test]
    fn test_contains_exponentiation() {
        let expr1 = Expression::exponentiation(Expression::integer(2), Expression::integer(3));
        let expr2 = Expression::exponentiation(Expression::integer(2), Expression::integer(3));
        assert!(expr1.contains(&expr2));
